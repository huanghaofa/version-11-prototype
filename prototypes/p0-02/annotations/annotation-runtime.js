(function () {
  ...
  function placeToggle(btn) {
    var topBar = document.querySelector('.top-bar, .topbar');
    var sideMenu = document.querySelector('.side-menu, .sidebar, .nav-panel, .app-sidebar');
    var top = topBar ? Math.max(topBar.offsetHeight + 12, topBar.getBoundingClientRect().bottom + 12) : 16;
