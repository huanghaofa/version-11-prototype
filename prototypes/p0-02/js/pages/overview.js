  ...
  function render() {
    var body =
      '<div class="grid-4">' +
        ...
        '<div class="metric-card"><strong>2</strong><span>适用场景：维修保养（新）、BIMC（新）</span></div>' +
      ...
      window.UI.panel('组合折扣券模型', '<div class="grid-3">' +
        ...
        '<article class="summary-card"><span class="number">3</span><h3>手工与 Excel 并行</h3><p>两种组合方式均可手工选品，也可下载模板后批量上传并查看校验结果。</p></article>' +
      '</div>') +
      '<div class="grid-2">' +
        window.UI.panel('卡券中心配置', '<ul class="rule-list"><li>只有组合折扣券开放多备件</li><li>自由组合配置商品最大核销数量</li><li>分组组合配置商品最低核销数量</li><li>Excel 支持追加或清空后覆盖</li></ul>') +
